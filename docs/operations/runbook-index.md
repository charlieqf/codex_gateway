...
- Desktop E2E opaque `cgu_live_*` key issuance through `scripts/issue-desktop-e2e-opaque-key.ps1`, documented in `docs/operations/medevidence-codex-key-provisioning.md`.
