...
> 截至 2026-08-04，目标已确定为 R760，正式四容器已在 loopback 完成部署和
> 真实 E2E，但尚未切换公网；CN1 只作为保持
...
> 第二次 peer-review 自检。执行层 `1.6.4` 只做可逆的工程投影和精简草稿协议：
...
RESEARCH_WEB_SEARCH_PROVIDER=direct|brave|serpapi
RESEARCH_WEB_SEARCH_API_KEY_FILE=/run/secrets/research_web_search_api_key
RESEARCH_SERPAPI_ENGINE=google|baidu
