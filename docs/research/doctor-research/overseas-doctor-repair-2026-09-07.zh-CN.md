...
本次修复截图中三位医生卡在身份发现/核验阶段的问题。修改在工作区，尚未提交、推送或部署。此前调查见 [失败调查](overseas-doctor-validation-2026-09-07.zh-CN.md)。
...
本补丁针对已知海外机构名称与通用召回缺陷，不构成全球机构名称库。发布后还需用三组原始输入完成公网全流程验收，并复核 Paola 报告中的任职时间表述。
