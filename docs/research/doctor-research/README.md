...
The production Worker uses frozen execution contract `1.6.36` together with the
...
For latency, execution `1.6.36` splits synthesis into three bounded independent
